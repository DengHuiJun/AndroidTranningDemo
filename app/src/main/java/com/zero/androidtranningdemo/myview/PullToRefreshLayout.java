...
public class PullToRefreshLayout extends LinearLayout implements View.OnTouchListener {
     ...
     */
    private boolean mIsEnabledToPull;
    ...
    public PullToRefreshLayout(Context context, AttributeSet attrs) {
        ...
        progressBar = (ProgressBar) mRefreshHeader.findViewById(R.id.progress_bar);
        mArrow = (ImageView) mRefreshHeader.findViewById(R.id.arrow);
        description = (TextView) mRefreshHeader.findViewById(R.id.description);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !mIsLoaded) {
            ...
            headerLayoutParams = (MarginLayoutParams) mRefreshHeader.getLayoutParams();
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (currentStatus != STATUS_REFRESHING) {
                        ...
                        mRefreshHeader.setLayoutParams(headerLayoutParams);
                    }
                    break;
    ...
    /**
     * 根据当前ListView的滚动状态来设定 {@link #mIsEnabledToPull}
    ...
    private void setIsAbleToPull(MotionEvent event) {
        ...
        if (firstChild != null) {
            ...
            if (firstVisiblePos == 0 && firstChild.getTop() == 0) {
                ...
                mIsEnabledToPull = true;
            } else {
                if (headerLayoutParams.topMargin != hideHeaderHeight) {
                    headerLayoutParams.topMargin = hideHeaderHeight;
                    mRefreshHeader.setLayoutParams(headerLayoutParams);
                }
                mIsEnabledToPull = false;
            }
        } else {
